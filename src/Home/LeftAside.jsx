...
const LeftAside = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center sticky top-3">
            ...
            <br />
            {cats.map(cat =>
                <NavLink to={`/category/${cat.category_id}`} key={cat.category_id} className=" text-center py-2 px-5 my-2 text-gray-400  w-full rounded-xl hover:bg-slate-50 hover:text-gray-500">
                    {cat.category_name}
                </NavLink>
            )}
        </div>
